        ...
        <div className="flex flex-col xl:flex-row">
          ...
          <div className="hidden xl:flex flex-1 relative">
            <DevImg
              ...
              imageSrc="/about/about-developer4.png"
            />
          </div>
          {/* tabs */}
                    ...
                    <div className="grid md:grid-cols-2 gap-y-8">
                      ...
                      <div className="flex flex-col gap-y-6">
                        <div className="flex gap-x-4 items-center text-[22px] text-primary">
                          ...
                          <h4 className="capitalize font-medium">
                            {
                              getData(qualificationData, TITLES.EXPERIENCE)
                                .title
                            }
                          </h4>
                        </div>
                      ...
                      <div className="flex flex-col gap-y-6">
                        <div className="flex gap-x-4 items-center text-[22px] text-primary">
                          ...
                          <h4 className="capitalize font-medium">
                            {getData(qualificationData, TITLES.EDUCATION).title}
                          </h4>
                        </div>
                        {/* list */}
                        <div className="flex flex-col gap-y-8">
                ...
                <TabsContent value="skills">
                  <div className="text-center xl:text-left">
                    ...
                    <div className="mb-16">
                      ...
                      {/* skill list */}
                      <div>
                        {getData(skillData, TITLES.SKILLS).data.map(
                          (item, index) => {
                            const { name } = item;
                            return (
                              <div
                    ...
                    <div>
                      ...
                      <div className="flex gap-x-8 justify-center xl:justify-start">
                        {getData(skillData, TITLES.TOOLS).data.map(
                          (item, index) => {
                            const { imgPath } = item;
                            return (
                              <div key={index}>
